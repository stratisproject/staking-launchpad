        ...
        <section>
          ...
          <section>
            ...
            <Alert variant="warning" className="mt30">
              ...
              <Text className="inline">
                <FormattedMessage defaultMessage="It is not possible to manually request specific amounts of STRAT to be withdrawn" />
              </Text>
            </Alert>
          </section>
          ...
          <section>
            ...
            <section className="actionable">
              ...
              <Text className="mb10">
                <FormattedMessage
                  defaultMessage="Those looking to exit their validator from staking and withdrawal their STRAT should
          ...
          <section>
            ...
            <Text className="mb10">
              <FormattedMessage
                ...
                eligible STRAT withdrawals (of which there are two types, more on this below). Validators are processed
          ...
          <section>
            ...
            <Text className="mb10">
              <FormattedMessage
                ...
                balance of {PRICE_PER_VALIDATOR} {TICKER_NAME}, this prevents large portions of the STRAT from potentially
          ...
          <section>
            ...
            <Text className="mb10">
              <FormattedMessage
                ...
                If the validator being checked has STRAT that is eligible to be withdrawn, it is added to the withdrawal
