      ...
      <Container>
        <TermsOfServiceStyles>
          ...
          <Text className="tos-text">
            ...
            by and between you and the Xertra ("Foundation", "we"
            ...
            xertra.com, including any content, functionality and services
            offered on or through xertra.com, ethereum.foundation, devcon.org,
            and blog.xertra.com (together, the "Website").
          </Text>
          <Text className="tos-text">
            ...
            <ul>
              <li>
                ...
                <Link
                  primary
                  inline
                  to="https://xertra.com/en/privacy-policy/"
                >
                  Privacy Policy
                </Link>
          ...
          <Text className="tos-text">
            The Foundation name, the terms Xertra Switzerland, Xertra Asia,
          ...
          <Text className="tos-text">
            ...
            <Link primary inline to="https://xertra.com/en/privacy-policy/">
              Privacy Policy
            </Link>
          ...
          <Text className="tos-text">
            ...
            between you and the Xertra with respect to the Websites
