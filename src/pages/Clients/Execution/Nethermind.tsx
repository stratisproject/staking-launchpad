...
export const NethermindDetails = () => (
  <>
    ...
    <Text className="mt10">
      <FormattedMessage defaultMessage="An Xertra client with a huge pool of developers. It's perfect for enterprise-grade systems." />
    </Text>
    <SectionTitle level={2} className="mb5">
    ...
    <section>
      ...
      {IS_MAINNET && (
        <>
          <Text className="mt10">
            <FormattedMessage
              defaultMessage="Use {mainnet} to sync the Xertra mainnet."
              values={{
