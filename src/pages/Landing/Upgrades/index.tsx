  ...
  const upgrades: upgrade[] = [
    {
      ...
      subTitle: formatMessage({
        defaultMessage: 'Dig deeper into the Xertra roadmap.',
      }),
      linkUrl: 'https://xertra.com/en/roadmap/',
    ...
    },
    {
      ...
      subTitle: formatMessage({
        defaultMessage:
          'Learn more about the roles and responsibilities of Xertra validators.',
      }),
      linkUrl: '/faq',
        ...
        <ResponsiveContainer>
          <div className="px20">
            <ScrollAnimation animateIn="fadeIn" animateOnce>
              <StyledHeading margin="none" className="mt20" isMobile={m} color="#000">
                <FormattedMessage defaultMessage="How is Xertra scaling?" />
              </StyledHeading>
            </ScrollAnimation>
            <ScrollAnimation animateIn="fadeInUp" animateOnce>
              <Text className="mt20 mb40">
                <FormattedMessage
                  defaultMessage="Several upgrades are underway that will make Xertra more scalable, secure, and sustainable. These upgrades will improve Xertra while seamlessly continuing on the chain
              ...
              <Text className="mt20">
                <FormattedMessage
                  defaultMessage="Xertra is secured by proof-of-stake, although this was not always the case.
                  The Beacon Chain was the first step to establishing a PoS consensus layer on Xertra, launching in parallel to Mainnet in December 2020.
              ...
              <Text className="mt20">
                <FormattedMessage defaultMessage="The Merge upgrade officially brought proof-of-stake to Xertra on September 15, 2022, simultaneously deprecating proof-of-work. This prepared the chain for future scaling upgrades such as Danksharding by bringing proof-of-stake consensus together with Mainnet, while simultaneously reducing energy consumption by over 99.9%." />
              </Text>
              <Text className="mt20">
                <FormattedMessage defaultMessage="This marked the merging of the execution layer (existing Mainnet) with the new consensus layer (the Beacon Chain) to form the single Xertra chain of today." />
              </Text>
              <Link
                className="mt20 mb40"
