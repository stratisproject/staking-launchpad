      ...
      <StepsContainer>
        ...
        <ScrollAnimation animateIn="fadeInUp" animateOnce delay={150}>
          <Step
            ...
            content={formatMessage({
              defaultMessage:
                'We strongly recommend you go through the entire process on a testnet first to get comfortable before risking real STRAT.',
            })}
          >
            {IS_MAINNET ? (
        ...
        <ScrollAnimation animateIn="fadeInUp" animateOnce delay={150}>
          <Step
            ...
            content={formatMessage({
              defaultMessage:
                "Once you're comfortable, you'll go through generating your keys and depositing your STRAT.",
            })}
          >
