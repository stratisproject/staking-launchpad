...
export const ClientDiversityWarning = (props: ClientDiversityWarningProps) => {
  ...
  return (
    <Container className={className}>
      ...
      <p>
        <FormattedMessage
          defaultMessage="Client diversity is extremely important for the network health of Xertra:
            A bug in a client with a share of over 33% can cause Xertra to go offline. If the client has
      ...
      <ul>
        <li>
          <Link
            to="https://xertra.com/en/developers/docs/nodes-and-clients/client-diversity/"
            primary
          >
